    ...
    return (
        <>
            ...
            <div className="contenedorServicios">
                <Link className="linkCard" to="/Monitoreo">
                ...
                <Link className="linkCard" to="/AI">
                    <div className="card" style={{ maxWidth: '800px', minHeight: '180px' }}>
                        <div className="row g-0">
                            <div className="col-md-4">
                                <img src="/IA.jpeg" className="img-fluid rounded-start" alt="inteligencia artificial" />
                            </div>
                            <div className="col-md-8">
                                <div className="card-body">
                ...
                <Link className="linkCard" to="/Cloud">
                    <div className="card" style={{ maxWidth: '800px', minHeight: '180px' }}>
                        <div className="row g-0">
                            <div className="col-md-4">
